	...
	<div class="tabs <?php etheme_option('tabs_type'); ?>">
		<?php if ( ! empty( $tabs ) ) : ?>
			<?php foreach ( $tabs as $key => $tab ) : ?>
				<?php /*<a href="#tab_<?php echo $key ?>" id="tab_<?php echo $key ?>" class="tab-title"><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', $tab['title'], $key ) ?></a>*/ ?>
        ...
        <?php if (etheme_get_custom_field('custom_tab1_title') && etheme_get_custom_field('custom_tab1_title') != '' ) : ?>
            <?php /*<a href="#tab_7" id="tab_7" class="tab-title"><?php etheme_custom_field('custom_tab1_title'); ?></a>*/ ?>
        ...
        <?php if (etheme_get_option('custom_tab_title') && etheme_get_option('custom_tab_title') != '' ) : ?>
            <?php /*<a href="#tab_9" id="tab_9" class="tab-title"><?php etheme_option('custom_tab_title'); ?></a>*/ ?>

	...
	<div class="page-heading bc-type-<?php etheme_option('breadcrumb_type'); ?>">
		<div class="container">
			<div class="row-fluid">
				...
				<?php if ( function_exists('yoast_breadcrumb') ) {yoast_breadcrumb('<div id="breadcrumb">','</div>');} ?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row-fluid">
			...
			<div class="content <?php echo $content_span; ?>">
				<?php if(have_posts()): while(have_posts()) : the_post(); ?>
					...
					<div class="contentwatch"><article <?php post_class('blog-post post-single'); ?> id="post-<?php the_ID(); ?>">
					...
					<!-- <h3 class="post-title"><?php /* the_title(); */ ?></h3> -->
						...
						<div class="post-info">
							...
							</span> <?php if(function_exists('the_ratings')) { the_ratings(); } ?>

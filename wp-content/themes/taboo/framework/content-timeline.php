...
<article <?php post_class($postClass); ?> id="post-<?php the_ID(); ?>" >
	...
	<?php if (count($images)>0 && has_post_thumbnail()): ?>
		<div class="post-images nav-type-small<?php if (count($images)>1): ?> images-slider<?php endif; ?>">
			<ul class="slides">
				<?php if(!$blog_slider): ?>
					<li><a href="<?php the_permalink(); ?>"><img src="<?php echo $images[0]; ?>" width="800" height="500"/></a></li>
				<?php else: ?>
					<?php foreach ($images as $key => $value): ?>
						<li><a href="<?php the_permalink(); ?>"><img src="<?php echo $value; ?>" width="800" height="500"/></a></li>
					<?php endforeach ?>
				<?php endif; ?>
			</ul>

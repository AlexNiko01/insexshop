...
<article <?php post_class($postClass); ?> id="post-<?php the_ID(); ?>" >
			...
			<ul class="slides">
				...
				<?php else: ?>
					<?php foreach ($images as $key => $value): ?>
						<li><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo $value; ?>" alt="<?php the_title(); ?>" width="800" height="500"/></a></li>
					<?php endforeach ?>
				<?php endif; ?>
			</ul>
	...
	<div class="post-info">
		...
		<?php /*<span class="posted-by"> <?php _e('by', ETHEME_DOMAIN);?> <?php the_author_posts_link(); ?></span> / */ ?>
		<span class="posted-by">Автор: <span class="vcard author"><span class="fn">Нимфоманка</span></span></span> /
		<span class="posted-in">Рубрика: <?php the_category(',&nbsp;') ?></span> 
		<?php // Display Comments 

			if(comments_open() && !post_password_required()) {
				echo ' / ';
				comments_popup_link('0 комментариев', '1 комментарий', '% комментариев', 'post-comments-count');
			}

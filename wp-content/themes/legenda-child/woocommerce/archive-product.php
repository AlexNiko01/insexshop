...
<div class="row-fluid vc_row-fluid">
	...
	<div class="vc_icon_element-inner vc_icon_element-color-sky vc_icon_element-size-xl vc_icon_element-style- vc_icon_element-background-color-grey">
		<span class="vc_icon_element-icon fa icon-user"></span></div></div>
		</div>
	</div>
	<div class="wpb_column span3">
		<div class="wpb_wrapper">
	...
	<div class="vc_icon_element vc_icon_element-outer vc_icon_element-align-center">
	<div class="vc_icon_element-inner vc_icon_element-color-sky vc_icon_element-size-xl vc_icon_element-style- vc_icon_element-background-color-grey">
		<span class="vc_icon_element-icon fa icon-credit-card"></span></div></div>
		</div>
	</div>
	<div class="wpb_column span3">
		<div class="wpb_wrapper">
	...
	<div class="vc_icon_element vc_icon_element-outer vc_icon_element-align-center">
	<div class="vc_icon_element-inner vc_icon_element-color-sky vc_icon_element-size-xl vc_icon_element-style- vc_icon_element-background-color-grey">
		<span class="vc_icon_element-icon fa icon-archive"></span></div></div>
		</div>
	</div>
	<div class="wpb_column span3">
		<div class="wpb_wrapper">
	...
	<div class="vc_icon_element vc_icon_element-outer vc_icon_element-align-center">
	<div class="vc_icon_element-inner vc_icon_element-color-sky vc_icon_element-size-xl vc_icon_element-style- vc_icon_element-background-color-grey">
	<span class="vc_icon_element-icon fa icon-headphones"></span></div></div>
		</div>
	</div></div></div>
<?php endif; ?>

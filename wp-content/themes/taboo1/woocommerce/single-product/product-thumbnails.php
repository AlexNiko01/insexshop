	...
	<div class="product-thumbnails-slider">
		...
		<ul class="slides">
			<?php if(has_post_thumbnail() ): ?>
				<li><a href="#" title="Фотография товара" class="main-image"><img src="<?php echo $image; ?>" alt="Фотография секс-игрушки<?php //echo $image_title ?>"></a></li>
				<?php if ($attachment_ids): ?>
					<?php foreach ($attachment_ids as $key => $value): ?>
						<li><a href="#" title="Фотография товара" class="main-image"><img src="<?php echo etheme_get_image($value, $thumbImageWidth, $thumbImageHeight, $thumbImageCrop); ?>" alt="Фотография секс-игрушки<?php //echo $image_title ?>"></a></li>
					<?php endforeach ?>						
				<?php endif ?>
			<?php endif; ?>

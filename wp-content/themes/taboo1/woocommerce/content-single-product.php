...
<div itemscope itemtype="https://schema.org/Product" class="single-product-page product">
    <?php /*<div itemscope itemtype="https://schema.org/Product" <?php post_class('single-product-page'); ?>>
<div itemscope itemtype="https://schema.org/Product" id="product-<?php the_ID(); ?>" <?php post_class('single-product-page'); ?>>*/ ?>
    <div class="row product-info sidebar-position-<?php echo $position; ?> responsive-sidebar-<?php echo $responsive; ?>">
        ...
        <div class="span<?php echo $meta_span; ?> product_meta">
            ...
            <?php /*<h4><?php _e('Product Information', ETHEME_DOMAIN) ?></h4>*/ ?>

            <?php woocommerce_template_loop_rating(); ?>


            <?php if ($product->is_type(array('simple', 'variable')) && $product->get_sku()) : ?>
                <div class="flr"><?php _e('Product code', ETHEME_DOMAIN); ?>: <span class="sku"
                                                                                    itemprop="sku"><?php echo $product->get_sku(); ?></span></span>
                </div>
                <div class="clear"></div>
            <?php endif; ?>
            ...
            <?php if (etheme_get_custom_field('size_guide_img')) : ?>
                ...
                <div class="size_guide">
                    <a rel="<?php echo $lightbox_rel; ?>"
                       href="<?php etheme_custom_field('size_guide_img'); ?>"><?php _e('SIZING GUIDE', ETHEME_DOMAIN); ?></a>
                </div>
            <?php endif; ?>
        ...
        <?php if ($single_product_sidebar && ($position == 'right' || ($responsive == 'bottom' && $position == 'left'))): ?>
            ...
            <div class="clear"></div>
        <?php endif; ?>
        <?php do_action('woocommerce_after_single_product_together'); ?>
    </div>
